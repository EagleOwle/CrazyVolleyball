...
namespace CrasyVolleyballServer.NetEntitys
{
    public class Player : NetEntity
    {
        public int test;
        bool old_res = false;
        public Player(Instance instance, GalaxyVector3 position = null, GalaxyQuaternion rotation = null, NetEntityAutoSync syncType = NetEntityAutoSync.position_and_rotation) : base(instance, position, rotation, syncType)
        {
            prefabName = "Player";
        }
